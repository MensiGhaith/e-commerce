...
<tr><th><div class="k">ID</div></th><th><div class="k">Username</div></th><th><div class="k">Email</div></th><th><div class="k">Action</div></th></div></tr>
    <?php
...
<tbody>
  <tr>
    <td><div class="k"><?php echo $t["Id"] ?></div></td>
    <td><div class="k"><?php echo $t["User_N"] ?></div></td>
    <td><div class="k"><?php echo $t["Email"] ?></div></td>
    <td><div class="k"><a href="php/delete.php?id=<?php echo $t['Id'] ?>"><i class="glyphicon glyphicon-remove"></i></a></div></td>
  </tr>
<?php }
  ?>
</table></tbody></center>
